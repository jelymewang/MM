...
def parse_args():
    ...
    parser.add_argument('--config', type=str, default='deep_rgbd',help='yaml configure file name')
    parser.add_argument('--save_dir', type=str, default='./output1', help='root directory to save checkpoints, logs, and tensorboard')
